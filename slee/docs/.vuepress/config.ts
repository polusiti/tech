...
const DOMAIN_NAME = 'tech.allfrom0.top' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
    ...
    base: '/slee/',  // VuePressは/slee/配下で動作
    locales: {
        '/': {
            lang: 'ja-JP',
    ...
    themeConfig: {
        ...
        repo: 'polusiti/tech', // 导航栏右侧生成Github链接
        ...
        author: {
            name: 'Tech Blog', // 必需
            link: 'https://github.com/polusiti/tech', // 可选的
        },
        ...
        footer: {
            ...
            copyrightInfo:
                'Tech Blog | <a href="https://github.com/polusiti/tech" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
        },
