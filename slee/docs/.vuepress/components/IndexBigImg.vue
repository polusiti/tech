...
export default {
    ...
    methods: {
        ...
        bgTimeColorAndTip() {
            ...
            if (hours >= 6 && hours < 9) {
                addTip(
                    `おはようございます~~，現在 ${hours}:${minutes}:${seconds}，朝ごはんを食べましたか？🍔`,
                    "info",
                    50,
                    4000
                );
                ...
                addTip(
                    `おはようございます~~，現在 ${hours}:${minutes}:${seconds}，サボらないように気をつけてください🐟~~`,
                    "info",
                    50,
                    4000
                );
                ...
                addTip(
                    `こんにちは~~，現在 ${hours}:${minutes}:${seconds}，お昼のご飯の時間です🍚~~`,
                    "info",
                    50,
                    4000
                );
                ...
                addTip(
                    `こんにちは~~，現在 ${hours}:${minutes}:${seconds}，忙しい午後も適度に休憩してください😴~~`,
                    "info",
                    50,
                    4000
                );
                ...
                addTip(
                    `こんにちは~~，現在 ${hours}:${minutes}:${seconds}，午後も頑張ってください🐟~~`,
                    "info",
                    50,
                    4000
                );
                ...
                addTip(
                    `夕方になりました~~，現在 ${hours}:${minutes}:${seconds}，夕食の準備をしましょう🥗🍖~~`,
                    "info",
                    50,
                    4000
                );
                ...
                addTip(
                    `こんばんは~~，現在 ${hours}:${minutes}:${seconds}，一日お疲れ様でした，運動もしましょう🏃‍♂️~~`,
                    "info",
                    50,
                    4000
                );
                ...
                addTip(
                    `こんばんは~~，現在 ${hours}:${minutes}:${seconds}，夜もこっそり勉強しましょう💯~~`,
                    "info",
                    50,
                    4000
                );
                ...
                addTip(
                    `こんばんは~~，現在 ${hours}:${minutes}:${seconds}，そろそろお風呂に入って寝ましょう🛀🥱😪~~`,
                    "info",
                    50,
                    4000
                );
                ...
                addTip(
                    `夜更かししないで~~，現在 ${hours}:${minutes}:${seconds}，早く寝て，朝日を一緒に楽しみましょう~~😇🛏`,
                    "info",
                    50,
                    4000
                );
